...
RF_datasetsub <- dataset[ ,c("pred_flow", "biomass_prey", "abund_prey",
                  "metabolism_prey", "biomass_pred", "abund_pred",
                  "metabolism_pred", "ecosystem_type", "habitat_type",
                   "water_temperature", "air_temperature", "dimensionality")]
...
ggsave("../master_talk/images/rf_var.png", plot = varImpPlot(m1),
...
inTraining <- createDataPartition(RF_datasetsub$pred_flow,
               p = .80, list = FALSE)
