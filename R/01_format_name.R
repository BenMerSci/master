...
GroupName[[2]][which(GroupName[[2]][,"original_name"] == "C. cafe"),"scientific_name"] <- "Farfantepenaeus californiensis"
GroupName[[2]][which(GroupName[[2]][,"original_name"] == "C. azul"),"scientific_name"] <- "Litopenaeus stylirostris"
GroupName[[2]][which(GroupName[[2]][,"original_name"] == "Zooplancton"),"scientific_name"] <- "Zooplankton"
GroupName[[2]][which(GroupName[[2]][,"original_name"] == "Fitoplancton"),"scientific_name"] <- "Phytoplankton"
...
# Web 15 - article OK
GroupName[[15]][which(GroupName[[15]][,"original_name"] == "Sea lion"),"scientific_name"] <- "Otaria flavescens"
...
GroupName[[15]][which(GroupName[[15]][,"original_name"] == "Rattail fish"),"scientific_name"] <- "Coelorinchus aconcagua"
GroupName[[15]][which(GroupName[[15]][,"original_name"] == "Big0eye flounder"),"scientific_name"] <- "Hippoglossina macrops"
...
GroupName[[17]][which(GroupName[[17]][,"original_name"] == "Phytoplankton"),"scientific_name"] <- "Phytoplankton"
...
GroupName[[18]][which(GroupName[[18]][,"original_name"] == "black drum"),"scientific_name"] <- "Pogonias cromis"
...
GroupName[[66]][which(GroupName[[66]][,"original_name"] == "Witch flounder"),"scientific_name"] <- "Glyptocephalus cynoglossus"
...
GroupName[[66]][which(GroupName[[66]][,"original_name"] == "Herring"),"scientific_name"] <- "Clupea harengus"
...
GroupName[[66]][which(GroupName[[66]][,"original_name"] == "Lobster"),"scientific_name"] <- "Homarus americanus"
...
GroupName[[68]][which(GroupName[[68]][,"original_name"] == "Witch flounder"),"scientific_name"] <- "Glyptocephalus cynoglossus"
...
GroupName[[68]][which(GroupName[[68]][,"original_name"] == "Herring"),"scientific_name"] <- "Clupea harengus"
...
GroupName[[68]][which(GroupName[[68]][,"original_name"] == "Lobster"),"scientific_name"] <- "Homarus americanus"
...
GroupName[[69]][which(GroupName[[69]][,"original_name"] == "Witch flounder"),"scientific_name"] <- "Glyptocephalus cynoglossus"
...
GroupName[[69]][which(GroupName[[69]][,"original_name"] == "Herring"),"scientific_name"] <- "Clupea harengus"
...
GroupName[[69]][which(GroupName[[69]][,"original_name"] == "Lobster"),"scientific_name"] <- "Homarus americanus"
...
# Web 73 - article OK
GroupName[[73]][which(GroupName[[73]][,"original_name"] == "Cormorant"),"scientific_name"] <- "Phalacrocorax carbo sinensis"
...
# Web 76 - article OK
GroupName[[76]][which(GroupName[[76]][,"original_name"] == "Sardine"),"scientific_name"] <- "Sardinops sagax"
...
# Web 77 - article OK
GroupName[[77]][which(GroupName[[77]][,"original_name"] == "Sardine"),"scientific_name"] <- "Sardinops sagax"
...
GroupName[[78]][which(GroupName[[78]][,"original_name"] == "S. cantharus"),"scientific_name"] <- "Spondyliosoma cantarus"
...
GroupName[[94]][which(GroupName[[94]][,"original_name"] == "O. saurus"),"scientific_name"] <- "Oligoplites saurus"
...
GroupName[[95]][which(GroupName[[95]][,"original_name"] == "Macro Zooplankton"),"scientific_name"] <- "Macrozooplankton"
GroupName[[95]][which(GroupName[[95]][,"original_name"] == "Micro Zoolplankton"),"scientific_name"] <- "Microzooplankton"
...
GroupName[[100]][which(GroupName[[100]][,"original_name"] == "Steindacchnerina insculpta"),"scientific_name"] <- "Steindachnerina insculpta"
...
GroupName[[100]][which(GroupName[[100]][,"original_name"] == "Acestrorhyncus lacustris"),"scientific_name"] <- "Acestrorhynchus lacustris"
...
GroupName[[100]][which(GroupName[[100]][,"original_name"] == "Hemisorubin platyrhynchos"),"scientific_name"] <- "Hemisorubim platyrhynchos"
...
GroupName[[105]][which(GroupName[[105]][,"original_name"] == "Herb. Zoolplankton"),"scientific_name"] <- "Herbivorous zooplankton"
...
GroupName[[110]][which(GroupName[[110]][,"original_name"] == "Ptarmigan"),"scientific_name"] <- "Lagopus muta"
...
GroupName[[110]][which(GroupName[[110]][,"original_name"] == "Gulls"),"scientific_name"] <- "Larus hyperboreus"
...
GroupName[[111]][which(GroupName[[111]][,"original_name"] == "Gulls"),"scientific_name"] <- "Larus hyperboreus"
GroupName[[111]][which(GroupName[[111]][,"original_name"] == "Passerines"),"scientific_name"] <- "Plectrophenax nivalis"
GroupName[[111]][which(GroupName[[111]][,"original_name"] == "Arctic_fox"),"scientific_name"] <- "Vulpes lagopus"
GroupName[[111]][which(GroupName[[111]][,"original_name"] == "Ptarmigan"),"scientific_name"] <- "Lagopus muta"
...
GroupName[[113]][which(GroupName[[113]][,"original_name"] == "Ptarmigan"),"scientific_name"] <- "Lagopus muta"
...
GroupName[[116]][which(GroupName[[116]][,"original_name"] == "Falcons"),"scientific_name"] <- "Falco peregrinus"
...
GroupName[[116]][which(GroupName[[116]][,"original_name"] == "Gulls"),"scientific_name"] <- "Larus hyperboreus"
